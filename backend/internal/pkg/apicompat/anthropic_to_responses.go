...
func AnthropicToResponses(req *AnthropicRequest) (*ResponsesRequest, error) {
	...
	// Only explicit output_config.effort should control reasoning effort.
	// When output_config.effort is unset, keep reasoning nil to avoid
	// forcing an expensive default reasoning level.
